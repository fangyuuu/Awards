...
(function (h) {
    ...
    function ca(a, b, c, d) {
        ...
        if ("dom" === c || (!c || "auto" === c) && "dom" === e.src)
            e._aData = Ha(a, e, d, d === k ? k : e._aData)
                    .data;
        else {
            var j = e.anCells;
            if (j)
    ...
    function jb(a) {
        ...
        if (null !== j) {
            ...
            for (c = a.length; b < c; b++)
                f = l[b], f.nTf = a[b].cell, f.sClass && h(f.nTf)
                        .addClass(f.sClass)
        }
    }
    ...
    function ka(a) {
        ...
        if (a.scrollBarVis !== K && a.scrollBarVis !== k)
            ...
            if ("" === c) {
                r.width = "100%";
                if (T && (p.find("tbody")
                        .height() > j.offsetHeight || "scroll" == l.css("overflow-y")))
    ...
    function Ea(a) {
        ...
        if (d || !t && !f && !e && j == aa(a) && j == n.length)
            for (m = 0; m < j; m++)
                i = Z(a, m), null !== i && (c[i].sWidth = v(n.eq(m)
                        .width()));
        else {
            j = h(b)
                    .clone()
            ...
            for (m = 0; m < i.length; m++)
                o = c[i[m]], n[m].style.width = null !== o.sWidthOrig && "" !== o.sWidthOrig ? v(o.sWidthOrig) : "", o.sWidthOrig && f && h(n[m])
                        .append(h("<div/>")
                                .css({
                                    width: o.sWidthOrig,
                                    margin: 0,
            ...
            for (m = e = 0; m < i.length; m++)
                k = h(n[m]), g = k.outerWidth() - k.width(), k = p.bBounding ? Math.ceil(n[m].getBoundingClientRect()
    ...
    function wa(a) {
        ...
        if (e.bSort && e.bSortClasses) {
            e = 0;
            for (f = b.length; e < f; e++)
                g = b[e].src, h(D(a.aoData, "anCells", g))
                        .removeClass(c + (2 > e ? e + 1 : 3));
            e = 0;
            for (f = d.length; e < f; e++)
                g = d[e].src, h(D(a.aoData, "anCells", g))
                ...
                var T = p.oFeatures,
                        e = function () {
                            ...
                            if (g.aaData)
                                ...
                                (p.bDeferLoading || y(p) == "dom") && ma(p, h(p.nTBody)
                                        .children("tr"));
                                ...
                                .length && (f.on("draw.dt.DT_details", function (a, b) {
                                    ...
                                    if (e === b)
                                        for (var c, d = aa(b), f = 0, h = g.length; f < h; f++)
                                            c = g[f], c._details && c._details.children("td[colspan]")
                                                    .attr("colspan", d)
            ...
            var d = c[0],
                    ...
                    f = function (a, b) {
                        if (h.isArray(a) || a instanceof h)
                            ...
                            a.nodeName && "tr" === a.nodeName.toLowerCase() ? e.push(a) : (c = h("<tr><td/></tr>")
                                    .addClass(b), h("td", c)
                                    .addClass(b)
